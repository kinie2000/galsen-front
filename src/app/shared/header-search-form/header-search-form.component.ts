...
import { TemplateSearchCar } from './../../app.models';
...
export class HeaderSearchFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.todayWithPipe = this.datePipe.transform(this.minDateStart, 'dd/MM/yyyy')
  ...
  public addressChange(address: any) {
    ...
    this.emitter.emit(address.geometry);
  ...
  public dateStartChange(event: any) {
    ...
    this.currentDateFormat = this.datePipe.transform(event.target.value, 'dd/MM/yyyy')!
  ...
  public search() {
    ...
    if(typeof this.address == 'undefined') {
      ...
      // this.templateSearchCar = {"address": this.address, "dateStart": this.dateStart,
