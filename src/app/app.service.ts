...
export class AppService {
  ...
  public getTestimonialsGalsen(){
    return [
        { 
            text: 'Meilleur rapport qualité prix.', 
            author: 'Serge', 
            position: 'Propriètaire', 
            image: 'assets/images/profile/adam.jpg' 
        },
        { 
            text: 'Site facile à utiliser, aucune difficulté pour effectuer une réservation.', 
            author: 'Line', 
            position: 'Locataire', 
            image: 'assets/images/profile/ashley.jpg' 
        },
        { 
            text: 'Très simple, efficace et les prix sont accessible à tous.', 
            author: 'Abdou', 
            position: 'Locataire', 
            image: 'assets/images/profile/bruno.jpg' 
        },
        { 
            text: 'Rapide, efficace et les termes de l\'offre sont très claires.', 
            author: 'Erica', 
            position: 'Locataire', 
            image: 'assets/images/profile/julia.jpg' 
        }
  ...
  public getSerciesGalsen(){
    return [  
        { name: 'award-1', image: 'assets/images/envie_voitue/weekend.jpg', description: 'Week-end' },
        { name: 'award-2', image: 'assets/images/envie_voitue/vac.jpg', description: 'Vacances' },
        { name: 'award-3', image: 'assets/images/envie_voitue/colis.jpg', description: 'Déménagement' },
        { name: 'award-4', image: 'assets/images/envie_voitue/wedding.jpg', description: 'Mariage' },
        { name: 'award-5', image: 'assets/images/envie_voitue/bussiness.jpg', description: 'Déplacement professionnel' }
    ];
  }
